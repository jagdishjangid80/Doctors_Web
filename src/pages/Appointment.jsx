  ...
  const getAvailableSlots = () => {
    ...
    for (let i = 0; i < 7; i++) {
      ...
      while (currentDate < endTime) {
        ...
        currentDate.setMinutes(currentDate.getMinutes() + 30); // 30-minute slots
      }
            ...
            {docSlots.length > 0 &&
              docSlots.map((item, index) => (
                <div
                  ...
                  onClick={() => {
                    setSlotIndex(index);
                    setSlotTime(item[0].time); // Set the selected slot time
                  }}
                >
            ...
            {docSlots.length &&
              docSlots[slotIndex].map((item, index) => (
                <p
                  ...
                  key={index}
                  onClick={() => setSlotTime(item.time)} // Update slotTime when a time is clicked
                >
